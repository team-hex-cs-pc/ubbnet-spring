...
public class UserController {
    ...
    @PostMapping("/add")
    public User add(@RequestBody User newEntity) { return this.service.addService(newEntity); }

    @PostMapping("/all")
    public List<User> addAll(@RequestBody List<User> list) { return this.service.addAllService(list); }
